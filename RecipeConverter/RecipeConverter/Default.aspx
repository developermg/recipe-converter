                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <asp:RangeValidator ControlToValidate="OriginalServingsText" runat="server" Type="Integer"
                                        MinimumValue="1" MaximumValue="1000" ErrorMessage="Original servings must be whole number between 1 and 1000" display="dynamic" ForeColor="#d9534f"></asp:RangeValidator>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <asp:RangeValidator ControlToValidate="DesiredServingsText" runat="server" Type="Integer"
                                        MinimumValue="1" MaximumValue="1000" ErrorMessage="Desired servings must be whole number between 1 and 1000" display="dynamic" ForeColor="#d9534f"></asp:RangeValidator>
